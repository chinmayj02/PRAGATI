        ...
        <form id="LoginForm" action="" method="post" class="needs-validation" novalidate autocomplete="off">
          ...
          <div class="row">
            <div class="form-group col-md-4">
                ...
                <small class="form-text text-muted">Please fill first name</small>
              </div> 
              <div class="form-group col-md-4">
              ...
              <div class="form-group col-md-4">
                ...
                <label for="inputcap"> Customer Id </label>
                <input type="text" class="form-control" id="inputc" name="ID" placeholder="Customer Id"/>
                <small class="form-text text-muted">Please write cust id</small>
              </div> 
            <div class="form-group col-md-4">
          ...
          <div class="form-group col-md-4">
            ...
            <small class="form-text text-muted">Please cpnfirm the password</small>
              ...
              <div class="form-group col-md-4">
                ...
                <label for="inputcap">city name </label>
                <input type="text" class="form-control" id="inputc" name="vname" placeholder="City name" required />
                <small class="form-text text-muted">Please fill the city name</small>
              </div> 
            <div class="form-group col-md-4">
