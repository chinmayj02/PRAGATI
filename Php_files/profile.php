...
<head>
  ...
  <body class="container bg-light">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <!-- Start Form -->
        <form id="LoginForm" action="/Php_files/profile.php" method="post" class="needs-validation" novalidate autocomplete="off">
          <!-- Start Input Name -->
          <div class="row">
                ...
                <div class="form-group col-md-4">
                 ...
                 <div class="form-group col-md-4">
                  ...
                  <div class="container signin">
                    <p>Already have an account? <a href="/html pages/login.html">Sign in</a>.</p>
                  </div>
